...
async function SwitchRegion(play) {
	const Group = $.read('BiliArea_Policy') || 'BiliPolicy'; //Your blibli policy group name.
	const CN = $.read('BiliArea_CN') || 'Bili_CN'; //Your China sub-policy name.
	const TW = $.read('BiliArea_TW') || 'Bili_TW'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || 'Bili_HK'; //Your HongKong sub-policy name.
	const DF = $.read('BiliArea_DF') || 'Bili_Blocked'; //Sub-policy name used after region is blocked(e.g. url 404)

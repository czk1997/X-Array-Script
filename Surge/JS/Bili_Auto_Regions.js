...
async function SwitchRegion(play) {
	const Group = $.read('BiliArea_Policy') || '哔哩哔哩自动切换''; //Your blibli policy group name.
	const CN = $.read('BiliArea_CN') || '国内直连'; //Your China sub-policy name.
	const TW = $.read('BiliArea_TW') || '台湾节点'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || '香港节点'; //Your HongKong sub-policy name.
	const DF = $.read('BiliArea_DF') || '国内直连'; //Sub-policy name used after region is blocked(e.g. url 404)
